...
const userSchema = new mongoose.Schema({
  ...
  personalData: {
    acadDetails: {
      name: { type: String, required: [true, "no name found"] },
      enrollmentNr: { type: String , required:[true, "enrollment not found"],unique: true},
    },
...
const testimonialDetail = mongoose.model(
  "testimonialDetail",
